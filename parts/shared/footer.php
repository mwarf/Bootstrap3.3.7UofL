...
<div class="footer">
  ...
  <li><span class="glyphicon glyphicon-list-alt"></span> <a href="http://directory.uleth.ca">University Directory</a></li>
  </ul>
		...
		<div  class="container">
			<div class="row">
				<div class="col-md-4">
					...
					<li><a href="#"><i class="fa fa-instagram"></i> @ulethbridge </li></a>
					<li><a href="#"><i class="fa fa-linkedin-square"></i> ulethbridge </li></a>-->
					<li><a href="#">Albert's Destination University </li></a>
